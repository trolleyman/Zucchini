...
public class Server implements Runnable
{
	...
	public void run()
	{
		...
		createLobby("TestLobbyT100", 2, 4);
		createLobby("SmallTestLobby", 1, 2);
		createLobby("TestLobbyT10", 2, 4);
		createLobby("TestLobbyT101", 2, 4);
		createLobby("TestLobbyT102", 2, 4);
		createLobby("TestLobbyT103", 2, 4);
		createLobby("TestLobbyT104", 2, 4);
